...
## Project Structure
    ...
    ├── testapiautoteammem_109149  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_109149`
...
2. Clone this repo and `cd testapiautoteammem_109149`
